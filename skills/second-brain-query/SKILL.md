...
Read `wiki/index.md` to identify relevant pages. Scan all category sections (Product, People, Concepts, Resources, Sources, Synthesis) and their subsections for entries related to the question.
...
> According to [[technology-name|Technology Name]], the key finding was X. This connects to the broader pattern described in [[process-name|Process Name]], which [[tool-name|Tool Name]] implements.
