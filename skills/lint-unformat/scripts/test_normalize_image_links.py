#!/usr/bin/env python3
"""
Unit tests for normalize_image_links.py
"""

import unittest
from normalize_image_links import normalize_image_links
...
class TestAnimatedEmoji(unittest.TestCase):
    ...
    def test_animated_emoji_gif(self):
        ...
        self.assertEqual(normalize_image_links(input_text), ":tada-animated:")

    def test_dancing_emoji(self):
        input_text = "![:parrot-dancing:](https://emoji.slack-edge.com/T123/parrot-dancing/abc.gif)"
        self.assertEqual(normalize_image_links(input_text), ":parrot-dancing:")
...
class TestBracketedEmoji(unittest.TestCase):
    ...
    def test_bracketed_animated_emoji(self):
        ...
        self.assertEqual(normalize_image_links(input_text), "[:rocket-launch:]")

    def test_multiple_bracketed_emoji(self):
        input_text = "[![:check:](https://url/a.png)] [![:x:](https://url/b.png)]"
        self.assertEqual(normalize_image_links(input_text), "[:check:] [:x:]")
...
class TestStatusEmoji(unittest.TestCase):
    ...
    def test_white_check_mark(self):
        self.assertEqual(
            normalize_image_links("![:white_check_mark:](https://url/a.png)"),
            ":white_check_mark:"
        )

    def test_warning(self):
        self.assertEqual(
            normalize_image_links("![:warning:](https://url/b.png)"),
            ":warning:"
        )

    def test_red_circle(self):
        self.assertEqual(
            normalize_image_links("![:red_circle:](https://url/c.png)"),
            ":red_circle:"
        )

    def test_large_green_circle(self):
        self.assertEqual(
            normalize_image_links("![:large_green_circle:](https://url/d.png)"),
            ":large_green_circle:"
        )

    def test_eyes(self):
        self.assertEqual(
            normalize_image_links("![:eyes:](https://url/e.png)"),
            ":eyes:"
        )

    def test_fire(self):
        self.assertEqual(
            normalize_image_links("![:fire:](https://url/f.png)"),
            ":fire:"
        )
...
- :wip: In progress
- :blocked: Blocked"""
        self.assertEqual(normalize_image_links(input_text), expected)
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_no_emoji(self):
        ...
        self.assertEqual(normalize_image_links(input_text), input_text)
    ...
    def test_empty_string(self):
        self.assertEqual(normalize_image_links(""), "")
...
:end:"""
    ...
    def test_complex_url_with_query_params(self):
        ...
        self.assertEqual(normalize_image_links(input_text), ":emoji:")
...
class TestDifferentURLFormats(unittest.TestCase):
    ...
    def test_jpg_extension(self):
        ...
        self.assertEqual(normalize_image_links(input_text), ":photo:")

    def test_jpeg_extension(self):
        input_text = "![:image:](https://emoji.slack-edge.com/T123/image/abc.jpeg)"
        self.assertEqual(normalize_image_links(input_text), ":image:")

    def test_gif_extension(self):
        input_text = "![:animated:](https://emoji.slack-edge.com/T123/animated/abc.gif)"
        self.assertEqual(normalize_image_links(input_text), ":animated:")
    ...
    def test_different_workspace_ids(self):
        ...
        for input_text in cases:
            self.assertEqual(normalize_image_links(input_text), ":test:")
